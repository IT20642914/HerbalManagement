  ...
  (0, _createClass2["default"])(MTableEditRow, [{
    ...
    value: function renderColumns() {
      ...
      var mapArr = this.props.columns.filter(function (columnDef) {
        ...
        var value = typeof _this2.state.data[columnDef.field] !== 'undefined' ? _this2.state.data[columnDef.field] : (0, _utils.selectFromObject)(_this2.state.data, columnDef.field);
        ...
        var getCellStyle = function getCellStyle(columnDef, value) {
          ...
          if (typeof columnDef.cellStyle === 'function') {
            cellStyle = _objectSpread(_objectSpread({}, cellStyle), columnDef.cellStyle(value, _this2.props.data));
          } else {
    ...
    value: function renderActions() {
      ...
      var localization = _objectSpread(_objectSpread({}, MTableEditRow.defaultProps.localization), this.props.localization);
