...
var DataManager = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(DataManager, [{
    ...
    key: "sort",
    value: function sort(a, b, type, orderDirection) {
      if (type === 'numeric') {
        return a - b;
      } else {
        if (a === b) {
    ...
    value: function sortList(list) {
      ...
      return list.sort(function sortData(a, b) {
        ...
        if (columnDef.customSort) {
          ...
          compareValue = sort(getFieldValue(a, columnDef), getFieldValue(b, columnDef), columnDef.type, orderDirection.toLowerCase());
